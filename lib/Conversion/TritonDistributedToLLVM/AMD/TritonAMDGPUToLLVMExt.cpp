...
#define GEN_PASS_DEF_CONVERTTRITONAMDGPUTOLLVMEXT
...
// adapt from triton/third_party/amd/lib/TritonAMDGPUToLLVM/TritonGPUToLLVM.cpp
...
struct ConvertTritonAMDGPUToLLVMExt
    : public triton::impl::ConvertTritonAMDGPUToLLVMExtBase<
          ConvertTritonAMDGPUToLLVMExt> {
  explicit ConvertTritonAMDGPUToLLVMExt(StringRef targetArch, bool ftz) {
...
createConvertTritonAMDGPUToLLVMExtPass(StringRef targetArch, bool ftz) {
  return std::make_unique<ConvertTritonAMDGPUToLLVMExt>(targetArch, ftz);
}
