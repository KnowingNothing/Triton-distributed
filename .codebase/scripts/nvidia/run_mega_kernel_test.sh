...
function run_mega_kernel_testcases() {
  ...
  NVSHMEM_DISABLE_CUDA_VMM=0 bash ./scripts/launch.sh python/triton_dist/mega_triton_kernel/test/models/test_qwen3.py --model Qwen/Qwen3-8B --backend mega_kernel
